            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="btn-group ms-auto" role="group">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Cuenta</a></li>
                        <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Archivo</a></li>
						<li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Galería</a></li>
						<li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#">Mapa</a></li>
						<li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#"><?php echo $salir; ?></p></a></li>
                    </ul>
                </div>
            </div>
        </div>
